...
function Logement() {
  // Récupération de l'identifiant du logement depuis les paramètres de l'URL
  const { id } = useParams()
  // Recherche du logement correspondant à l'identifiant
  ...
  // Fonction pour générer l'évaluation en étoiles
      ...
      stars.push(
        ...
        >
          <path
            ...
            fill="#FF6060"
          />
          {/* Chemin SVG pour une étoile pleine */}
        </svg>,
      )
    }
      ...
      stars.push(
        ...
        >
          <path
            ...
            fill="#E3E3E3"
          />
          {/* Chemin SVG pour une étoile vide */}
        </svg>,
      )
    }
